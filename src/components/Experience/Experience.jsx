        ...
        <motion.div
            ...
            <div className={css.leftSide}>
                {projectExperience.map((exp, i) => {
                    return <motion.div variants={fadeIn("right", "tween", (i + 1) * 0.2, 1)} className={css.exp}
                                       key={i}>
                        ...
                        <div>
                            <span>{exp.name}</span>
                            <span className="secondaryText">{exp.projects} Completed</span>
                        </div>
                    </motion.div>;
                })
                }
            ...
            <motion.div
                ...
                <span className="primaryText">What is my goal? </span>
